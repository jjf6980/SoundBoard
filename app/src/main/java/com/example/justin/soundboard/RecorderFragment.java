...
public class RecorderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_recorder2, container, false);

        final MediaRecorder mrec = new MediaRecorder();
        ...
        audioFilePath =
                Environment.getExternalStorageDirectory().getAbsolutePath()
                        + "/"+btn+"myaudio.3gp";
        mrec.setOutputFile(audioFilePath);
        mrec.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB);
        play = (Button) view.findViewById(R.id.button3);
    ...
    public void passData(String data, int num) {
        dataPasser.onDataPass(data,num);
    }
